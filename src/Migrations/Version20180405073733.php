...
class Version20180405073733 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql(
            "INSERT INTO `symfony`.`projects` (`id`, `category_id`, `user_id`, `flag_create`,`city_id`, `title`,`description`, `image`, `duration`, `goal`, `reached`, `charity_fund`) VALUES (1 ,2, 1, 0,1,'Earth Days', 'Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem. Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', 'http://dummyimage.com/217x214.png/5fa2dd/ffffff', 118, 160, 132, 'Kuvalis, Bashirian and Streich'),
